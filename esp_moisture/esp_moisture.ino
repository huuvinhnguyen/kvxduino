...
const char* ssid = "Ving";    // name of your wifi network!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const char* password = "123456789";     // wifi pasword !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
String GAS_ID = "AKfycbwgxuymLmJUfVqS_VCydeCKgQjqEwCnIUNs818qm2xAzmfO_vw";   // Replace by your GAS service id           !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
int it = 0;
int ih = 0;
void setup() 
{
